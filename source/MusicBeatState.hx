...
class MusicBeatState extends FlxUIState
{
	...
	public function initLua(?includeDebugGroup:Bool = true, ?nameOverride:String)
	{
		instance = this;
		...
		var foldersToCheck:Array<String> = [
			Paths.getPreloadPath('scripts/$idiotState/'),
			Paths.mods('scripts/$idiotState/'),
			Paths.mods('scripts/'),
	...
	{ // returns haxe values instead of just function_stop and function_continue
		var ret = null;
		for (hscript in hscriptArray)
		{
